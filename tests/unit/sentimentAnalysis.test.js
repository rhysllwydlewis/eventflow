...
describe('Sentiment Analysis', () => {
  describe('analyzeSentiment', () => {
    ...
    it('should detect negative sentiment', () => {
      const text =
        'Terrible service, awful experience, horrible quality. Very disappointing and poor work. Would not recommend at all. Complete disaster and waste of money.';
      const result = sentimentAnalysis.analyzeSentiment(text);
    ...
    it('should handle text with mixed sentiment', () => {
      const text =
        'Great photographer but terrible communication. Beautiful photos but poor service.';
      const result = sentimentAnalysis.analyzeSentiment(text);
  ...
  describe('detectSpam', () => {
    ...
    it('should not flag legitimate reviews as spam', () => {
      const text =
        'We hired this photographer for our wedding and were extremely happy with the results. The photos captured every special moment beautifully.';
      const result = sentimentAnalysis.detectSpam(text);
  ...
  describe('analyzeReview', () => {
    it('should provide comprehensive analysis', () => {
      ...
      const text =
        'We had an excellent experience. The photographer was professional and creative. Highly recommended!';
