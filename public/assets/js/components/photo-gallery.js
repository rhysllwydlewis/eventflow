...
class PhotoGallery {
  ...
  createLightbox() {
    ...
    // Event listeners
    this.lightboxElement.querySelector('.photo-gallery__lightbox-close').addEventListener('click', () => this.closeLightbox());
    this.lightboxElement.querySelector('.photo-gallery__lightbox-nav--prev').addEventListener('click', () => this.previousPhoto());
    this.lightboxElement.querySelector('.photo-gallery__lightbox-nav--next').addEventListener('click', () => this.nextPhoto());
