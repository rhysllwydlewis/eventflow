  ...
  if (!Array.isArray(existingCategories) || existingCategories.length === 0) {
    const categories = [
      ...
      },
      {
        ...
        name: 'Cake & Desserts',
        slug: 'cake-desserts',
        description: 'Beautiful wedding cakes and delicious dessert options',
        heroImage: '',
        icon: '🎂',
        order: 11,
        visible: true,
      },
      {
        ...
        name: 'Bar Services',
        slug: 'bar-services',
        description: 'Professional bar staff and mobile bar hire for your event',
        heroImage: '',
        icon: '🍸',
        order: 12,
        visible: true,
      },
      {
        ...
        name: 'Furniture Hire',
        slug: 'furniture-hire',
        description: 'Tables, chairs, and furniture rental for any event size',
        heroImage: '',
        icon: '🪑',
        order: 13,
        visible: true,
      },
      {
        ...
        name: 'Marquees',
        slug: 'marquees',
        description: 'Elegant marquee and tent hire for outdoor events',
        heroImage: '',
        icon: '⛺',
        order: 14,
        visible: true,
      },
      {
        ...
        name: 'Security',
        slug: 'security',
        description: 'Professional security services to keep your event safe',
        heroImage: '',
        icon: '🛡️',
        order: 15,
        visible: true,
      },
      {
        ...
        name: 'Event Staff',
        slug: 'event-staff',
        description: 'Experienced event staff and hospitality professionals',
        heroImage: '',
        icon: '👔',
        order: 16,
        visible: true,
      },
      {
        ...
        name: 'Invitations',
        slug: 'invitations',
        description: 'Beautiful stationery and invitations for your event',
        heroImage: '',
        icon: '💌',
        order: 17,
        visible: true,
      },
      {
        ...
        name: 'Photo Booths',
        slug: 'photo-booths',
        description: 'Fun photo booth hire with instant prints and props',
        heroImage: '',
        icon: '📷',
        order: 18,
        visible: true,
      },
      {
        ...
        name: 'Live Bands',
        slug: 'live-bands',
        description: 'Live musical performances to entertain your guests',
        heroImage: '',
        icon: '🎸',
        order: 19,
        visible: true,
      },
      {
        ...
        name: 'MCs & Hosts',
        slug: 'mcs-hosts',
        description: 'Professional hosts and MCs to keep your event flowing',
        heroImage: '',
        icon: '🎤',
        order: 20,
        visible: true,
      ...
      {
        id: 'cat_sound_equipment',
        name: 'Sound Equipment',
        slug: 'sound-equipment',
        description: 'Professional sound systems and audio equipment rental',
        heroImage: '',
        icon: '🔊',
        order: 21,
        visible: true,
      },
      {
        ...
        name: 'Stage Hire',
        slug: 'stage-hire',
        description: 'Stage platforms and staging solutions for performances',
        heroImage: '',
        icon: '🎭',
        order: 22,
        visible: true,
      },
      {
        ...
        name: 'Props',
        slug: 'props',
        description: 'Decorative props and accessories to enhance your theme',
        heroImage: '',
        icon: '🎪',
        order: 23,
        visible: true,
      ...
      {
        id: 'cat_ice_sculptures',
        name: 'Ice Sculptures',
        slug: 'ice-sculptures',
        description: 'Stunning ice sculptures and decorative ice features',
        heroImage: '',
        icon: '🧊',
        order: 25,
        visible: true,
      },
      {
        ...
        name: 'Fireworks',
        slug: 'fireworks',
        description: 'Professional fireworks displays for spectacular endings',
        heroImage: '',
        icon: '🎆',
        order: 26,
        visible: true,
      },
      {
        ...
        name: 'Drones',
        slug: 'drones',
        description: 'Aerial photography and drone light shows',
        heroImage: '',
        icon: '🚁',
        order: 27,
        visible: true,
      ...
      },
      {
        ...
        name: 'Hair Stylists',
        slug: 'hair-stylists',
        description: 'Expert hair styling services for weddings and events',
        heroImage: '',
        icon: '💇',
        order: 29,
        visible: true,
      },
      {
        ...
        name: 'Childcare',
        slug: 'childcare',
        description: 'Professional childcare and entertainment for young guests',
        heroImage: '',
        icon: '👶',
        order: 30,
        visible: true,
      ...
      {
        id: 'cat_accessibility',
        name: 'Accessibility Services',
        slug: 'accessibility-services',
        description: 'Services to make your event accessible to all guests',
        heroImage: '',
        icon: '♿',
        order: 31,
        visible: true,
      ...
      },
      {
        ...
        name: 'AV Equipment',
        slug: 'av-equipment',
        description: 'Audiovisual equipment rental and technical support',
        heroImage: '',
        icon: '📽️',
        order: 33,
        visible: true,
      },
      {
        ...
        name: 'Generators',
        slug: 'generators',
        description: 'Power generators and electrical equipment for outdoor events',
        heroImage: '',
        icon: '⚡',
        order: 34,
        visible: true,
      },
      {
        ...
        name: 'Toilets',
        slug: 'toilets',
        description: 'Luxury portable toilets and facilities for outdoor events',
        heroImage: '',
        icon: '🚻',
        order: 35,
        visible: true,
      },
      {
        ...
        description: 'Professional cleaning before, during, and after your event',
        heroImage: '',
        icon: '🧹',
        order: 36,
        visible: true,
    ...
    console.log('Created 36 demo categories for 6x6 grid');
  }
